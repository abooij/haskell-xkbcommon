...
testUpdateKey km = do
   ...
   updateKeyboardStateKey st keycode_numlock keyDown
   updateKeyboardStateKey st keycode_numlock keyUp
   blergh (stateModNameIsActive st modname_caps stateModLocked)
   ...
   updateKeyboardStateKey st keycode_compose keyDown
   updateKeyboardStateKey st keycode_compose keyUp
   ...
   updateKeyboardStateKey st keycode_6 keyDown
   updateKeyboardStateKey st keycode_6 keyUp
...
testSerialisation km = do
   ...
   updateKeyboardStateKey st keycode_leftshift keyDown
...
testConsume km = do
   ...
   updateKeyboardStateKey st keycode_leftalt keyDown
   updateKeyboardStateKey st keycode_leftshift keyDown
   updateKeyboardStateKey st keycode_equal keyDown
